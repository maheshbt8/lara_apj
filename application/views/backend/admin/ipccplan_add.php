                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="" class="form-control" placeholder="Plan name here">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-4 control-label text-sm-right pt-2" placeholder="">Acctual Price: </label>
                                                <div class="col-sm-6">
