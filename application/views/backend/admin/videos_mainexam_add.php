<!--Add video page in Main Exam Section-->
                            <div class="row">
                                <div class="col">
                                    <section class="card">
                                       
                                        <div class="card-body">
                                             <h3><b>+ </b>Add a New Video</h3>
                                            <form method="post" action="<?=base_url('videos_mainexam_add');?>" enctype="multipart/form-data" novalidate="novalidate" class="form-horizontal" id="form">
...
foreach ($course as $row) {?>
        <option value="<?=$row['id'];?>"><?=$row['course'];?></option>
                            <?php }?>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-4 control-label text-sm-right pt-2">Video Link: </label>
                                                    <div class="col-sm-8">
