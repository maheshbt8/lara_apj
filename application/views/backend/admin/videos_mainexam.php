...
foreach ($course as $row) {?>
        <option value="<?=$row['id'];?>"><?=$row['course'];?></option>
                            <?php }?>
                                            ...
                                            <div class="col-lg-2 ">
                                                <a href="<?=base_url('videos_mainexam_add');?>"><button type="submit" class="btn btn-info w-100" alt="Add new notes"><b>+ </b>Add</button></a>
                                            </div>    
                                        </div>    
                                    </div>
                                    <div class="card-body">
...
if($get_course!='' || $get_subject!=''){
    ...
    $notes=$this->crud_model->get_mainvideos_where_info($where);
}else{
    $notes=$this->crud_model->get_mainvideos_info();
}
