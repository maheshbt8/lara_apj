                                        ...
                                        <table class="table table-bordered table-striped mb-0" id="trail-download">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?=base_url('uploads/main/questions/'.$td['exam_id'].'.pdf');?>" alt="download" class="btn btn-success" download="question-paper">Download</a></td>
...
<form method="post" action="<?=base_url('e_mainexams');?>" enctype="multipart/form-data" class="form-horizontal" >
        <div class="form-group row">
            ...
            <?php echo form_error('subject', '<div class="error">', '</div>'); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="out_of" class="form-control" required="" value="<?=$td['max_marks']?>" readonly>
                                                </div>
                                                <?php echo form_error('subject', '<div class="error">', '</div>'); ?>
                                            </div>
        <div class="form-group row">
     ...
     <div class="offset-4 col-sm-5">
      <input type="submit" class="btn btn-primary" Placeholder="Submit">
                                                        ...
                                                        <?php }elseif($td['row_status']==2){?>
                                                            <a href="<?=base_url('uploads/main/answers/'.$td['id'].'.pdf');?>" onclick="update_download_event(<?php echo $td['id'];?>, 3, 'exam_downloads')" class="btn btn-success" download="<?php echo $td['unique_id'].'-'.$td['syllabus']; ?>"><?=$td['unique_id'].'-'.$td['syllabus'];?>-Answer-paper.pdf</a>
                                                        <?php }?>
