...
<div class="row">
                                                    ...
                                                    <div id="subject1" class="tab-pane active">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <div class="embed-responsive embed-responsive-16by9">
                                                                <iframe class="embed-responsive-item" src="<?php echo base_url();?>uploads/trail/questions/<?php echo $exam_id;?>.pdf"></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    
                                                    <div id="subject2" class="tab-pane ">
                                                    	<?php $row_status =  (int)$this->crud_model->get_type_name_by_id('trail_exam_downloads', $_GET['id'], 'row_status');
        ...
        <?php if(($this->session->userdata('role_id') != 2 && $row_status < 2)){?>
            <div class="col-lg-12 h-400">
                <div class="main-error mb-3 pt-135">
                <h2 class="error-code text-dark text-center font-weight-semibold m-0">Key<i class="fas fa-file"></i></h2>
                <p class="error-explanation text-center">Waiting for user upload answer paper .</p>
                </div>
                </div>                                                        
        <?php }elseif(($this->session->userdata('role_id') == 2 && $row_status < 2)){?>
    ...
    <?php if(($this->session->userdata('role_id') == 3 && $row_status == 3)){?>
<form method="post" action="<?=base_url('papers');?>" enctype="multipart/form-data" novalidate="novalidate" class="form-horizontal" id="form">
        <div class="form-group row">
